...
// 수능까지남은 일수 계산
const timeDiff = ((test.getTime()) - now.getTime())+9000;

const daysUntilTest = Math.floor(timeDiff / ((1000 * 60 * 60 * 24) + 1));
document.getElementById('dDay').innerHTML = 'D - ' + daysUntilTest;


// D - 100 표시
const day100 = new Date((test.getTime() - 100 * (1000 * 60 * 60 * 24))+9000);
